...
id: SCR-LIB-DYNAMICS-LINEAR
name: Dynamics Linear
...
Dynamical systems obeying the superposition principle, expressible as linear matrix operators.

---

## 1. Semantic Definition

**Linear** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines dynamical systems obeying the superposition principle, expressible as linear matrix operators.
...
All operations within `Linear` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Linear` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
