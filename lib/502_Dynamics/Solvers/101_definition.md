...
id: SCR-LIB-DYNAMICS-SOLVERS
name: Dynamics Solvers
...
# SCR Dynamics: Solvers

## Summary

Computational engines resolving algebraic, differential, and boundary-value dynamical problems.

---

## 1. Semantic Definition

**Solvers** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines computational engines resolving algebraic, differential, and boundary-value dynamical problems.
...
All operations within `Solvers` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Solvers` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
