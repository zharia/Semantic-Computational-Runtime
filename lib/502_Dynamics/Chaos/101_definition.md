...
Aperiodic deterministic dynamics exhibiting sensitive dependence on initial conditions.

---

## 1. Semantic Definition

**Chaos** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines aperiodic deterministic dynamics exhibiting sensitive dependence on initial conditions.
...
All operations within `Chaos` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Chaos` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
