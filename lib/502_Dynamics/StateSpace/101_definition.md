...
id: SCR-LIB-DYNAMICS-STATESPACE
name: Dynamics StateSpace
...
# SCR Dynamics: StateSpace

## Summary

Mathematical manifold or set containing all admissible states of a dynamical system.

---

## 1. Semantic Definition

**StateSpace** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines mathematical manifold or set containing all admissible states of a dynamical system.
...
All operations within `StateSpace` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `StateSpace` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
