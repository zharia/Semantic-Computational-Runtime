...
id: SCR-LIB-DYNAMICS-EVOLUTION
name: Dynamics Evolution
...
# SCR Dynamics: Evolution

## Summary

The unfolding of a dynamical trajectory through state space over time.

---

## 1. Semantic Definition

**Evolution** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines the unfolding of a dynamical trajectory through state space over time.
...
All operations within `Evolution` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Evolution` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
