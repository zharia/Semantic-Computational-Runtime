...
id: SCR-LIB-DYNAMICS-TIMESCALE
name: Dynamics Timescale
...
# SCR Dynamics: Timescale

## Summary

Characteristic temporal magnitude, rate, or hierarchy over which dynamical phenomena unfold.

---

## 1. Semantic Definition

**Timescale** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines characteristic temporal magnitude, rate, or hierarchy over which dynamical phenomena unfold.
...
All operations within `Timescale` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Timescale` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
