...
id: SCR-LIB-DYNAMICS-INTEGRATORS
name: Dynamics Integrators
...
# SCR Dynamics: Integrators

## Summary

Algorithmic temporal integration schemes (symplectic, explicit, implicit, Runge-Kutta, Verlet).

---

## 1. Semantic Definition

**Integrators** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines algorithmic temporal integration schemes (symplectic, explicit, implicit, Runge-Kutta, Verlet).
...
All operations within `Integrators` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Integrators` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
