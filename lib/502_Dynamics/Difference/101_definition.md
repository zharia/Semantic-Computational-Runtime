...
id: SCR-LIB-DYNAMICS-DIFFERENCE
name: Dynamics Difference
...
# SCR Dynamics: Difference

## Summary

Discrete recurrence formulations mapping state at step k to step k+1.

---

## 1. Semantic Definition

**Difference** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines discrete recurrence formulations mapping state at step k to step k+1.
...
All operations within `Difference` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Difference` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
