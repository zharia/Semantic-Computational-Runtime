...
id: SCR-LIB-DYNAMICS-PHASESPACE
name: Dynamics PhaseSpace
...
# SCR Dynamics: PhaseSpace

## Summary

State space representing both generalised coordinates and their conjugate momenta.

---

## 1. Semantic Definition

**PhaseSpace** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines state space representing both generalised coordinates and their conjugate momenta.
...
All operations within `PhaseSpace` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `PhaseSpace` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
