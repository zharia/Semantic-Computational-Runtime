...
id: SCR-LIB-DYNAMICS-OPERATORS
name: Dynamics Operators
...
# SCR Dynamics: Operators

## Summary

Abstract mathematical operators (Koopman, Perron-Frobenius, Liouville) advancing states or observables.

---

## 1. Semantic Definition

**Operators** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines abstract mathematical operators (Koopman, Perron-Frobenius, Liouville) advancing states or observables.
...
All operations within `Operators` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Operators` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
