...
id: SCR-LIB-DYNAMICS-DISCRETE
name: Dynamics Discrete
...
# SCR Dynamics: Discrete

## Summary

Dynamical systems evolving in discrete stages or integer time steps according to difference equations.

---

## 1. Semantic Definition

**Discrete** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines dynamical systems evolving in discrete stages or integer time steps according to difference equations.
...
All operations within `Discrete` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Discrete` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
