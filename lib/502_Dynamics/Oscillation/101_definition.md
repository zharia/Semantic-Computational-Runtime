...
id: SCR-LIB-DYNAMICS-OSCILLATION
name: Dynamics Oscillation
...
# SCR Dynamics: Oscillation

## Summary

Repetitive cyclic or periodic variation of state variables about a central equilibrium.

---

## 1. Semantic Definition

**Oscillation** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines repetitive cyclic or periodic variation of state variables about a central equilibrium.
...
All operations within `Oscillation` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Oscillation` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
