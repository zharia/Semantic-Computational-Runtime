...
Instantaneous configuration and assignment of all relevant values characterizing a system.

---

## 1. Semantic Definition

**State** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines instantaneous configuration and assignment of all relevant values characterizing a system.
...
All operations within `State` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `State` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
