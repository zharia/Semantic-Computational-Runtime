...
id: SCR-LIB-DYNAMICS-FEEDBACK
name: Dynamics Feedback
...
# SCR Dynamics: Feedback

## Summary

Process whereby output or evolved state feeds back to influence future input or rates of change.

---

## 1. Semantic Definition

**Feedback** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines process whereby output or evolved state feeds back to influence future input or rates of change.
...
All operations within `Feedback` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Feedback` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
