...
id: SCR-LIB-DYNAMICS-DIFFERENTIAL
name: Dynamics Differential
...
# SCR Dynamics: Differential

## Summary

Continuous formulations expressing infinitesimal rates of state change.

---

## 1. Semantic Definition

**Differential** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines continuous formulations expressing infinitesimal rates of state change.
...
All operations within `Differential` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Differential` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
