...
id: SCR-LIB-DYNAMICS-COUPLING
name: Dynamics Coupling
...
# SCR Dynamics: Coupling

## Summary

Mutual interaction and bidirectional state influence between distinct dynamical subsystems.

---

## 1. Semantic Definition

**Coupling** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines mutual interaction and bidirectional state influence between distinct dynamical subsystems.
...
All operations within `Coupling` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Coupling` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
