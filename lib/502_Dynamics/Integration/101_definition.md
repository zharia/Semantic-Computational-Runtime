...
id: SCR-LIB-DYNAMICS-INTEGRATION
...
# SCR Dynamics: Integration

## Summary

Mathematical and algorithmic accumulation of continuous rates of change over finite intervals.

---

## 1. Semantic Definition

**Integration** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines mathematical and algorithmic accumulation of continuous rates of change over finite intervals.
...
All operations within `Integration` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Integration` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
