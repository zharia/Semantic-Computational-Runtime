...
id: SCR-LIB-DYNAMICS-ATTRACTOR
name: Dynamics Attractor
...
# SCR Dynamics: Attractor

## Summary

Invariant set in phase space toward which neighbouring trajectories asymptotically converge.

---

## 1. Semantic Definition

**Attractor** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines invariant set in phase space toward which neighbouring trajectories asymptotically converge.
...
All operations within `Attractor` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Attractor` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
