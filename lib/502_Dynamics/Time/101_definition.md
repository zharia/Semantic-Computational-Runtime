...
Fundamental independent parameter ordering and indexing dynamical evolution.

---

## 1. Semantic Definition

**Time** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines fundamental independent parameter ordering and indexing dynamical evolution.
...
All operations within `Time` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Time` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
