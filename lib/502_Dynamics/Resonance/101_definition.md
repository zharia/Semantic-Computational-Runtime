...
id: SCR-LIB-DYNAMICS-RESONANCE
name: Dynamics Resonance
...
# SCR Dynamics: Resonance

## Summary

Amplified oscillatory response occurring when driving frequency matches natural system frequency.

---

## 1. Semantic Definition

**Resonance** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines amplified oscillatory response occurring when driving frequency matches natural system frequency.
...
All operations within `Resonance` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Resonance` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
