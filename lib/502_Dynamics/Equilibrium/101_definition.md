...
id: SCR-LIB-DYNAMICS-EQUILIBRIUM
name: Dynamics Equilibrium
...
# SCR Dynamics: Equilibrium

## Summary

Fixed point or stationary state where all rates of change vanish (dx/dt = 0).

---

## 1. Semantic Definition

**Equilibrium** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines fixed point or stationary state where all rates of change vanish (dx/dt = 0).
...
All operations within `Equilibrium` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Equilibrium` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
