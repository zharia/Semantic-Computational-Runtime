...
id: SCR-LIB-DYNAMICS-CONTINUOUS
name: Dynamics Continuous
...
# SCR Dynamics: Continuous

## Summary

Dynamical systems evolving continuously over real-valued time domains according to differential equations.

---

## 1. Semantic Definition

**Continuous** is a first-class subdomain of SCR Dynamics (`SCR-LIB-DYNAMICS`). It defines dynamical systems evolving continuously over real-valued time domains according to differential equations.
...
All operations within `Continuous` MUST adhere to the normative invariants of `SCR-LIB-DYNAMICS`:
...
This document establishes the normative semantic meaning of `Continuous` in SCR Dynamics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
