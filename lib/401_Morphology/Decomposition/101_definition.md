...
id: SCR-LIB-MORPHOLOGY-DECOMPOSITION
name: Morphology Decomposition
...
# SCR Morphology: Decomposition

## Summary

Hierarchical segmentation and structural partitioning of a morphological entity into parts.

---

## 1. Semantic Definition

**Decomposition** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses hierarchical segmentation and structural partitioning of a morphological entity into parts.
...
All operations within `Decomposition` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Decomposition are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Decomposition` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
