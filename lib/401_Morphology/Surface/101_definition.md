...
id: SCR-LIB-MORPHOLOGY-SURFACE
name: Morphology Surface
...
# SCR Morphology: Surface

## Summary

Two-dimensional outer shell, boundary layer, and surface morphology of an entity.

---

## 1. Semantic Definition

**Surface** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses two-dimensional outer shell, boundary layer, and surface morphology of an entity.
...
All operations within `Surface` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Surface are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Surface` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
