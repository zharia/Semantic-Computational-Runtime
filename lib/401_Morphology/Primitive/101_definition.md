...
id: SCR-LIB-MORPHOLOGY-PRIMITIVE
name: Morphology Primitive
...
# SCR Morphology: Primitive

## Summary

Foundational structural building blocks from which complex compound morphologies are assembled.

---

## 1. Semantic Definition

**Primitive** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses foundational structural building blocks from which complex compound morphologies are assembled.
...
All operations within `Primitive` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Primitive are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Primitive` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
