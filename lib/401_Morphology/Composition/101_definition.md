...
id: SCR-LIB-MORPHOLOGY-COMPOSITION
name: Morphology Composition
...
# SCR Morphology: Composition

## Summary

Assembly and synthesis of multiple morphological components into a unified structural whole.

---

## 1. Semantic Definition

**Composition** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses assembly and synthesis of multiple morphological components into a unified structural whole.
...
All operations within `Composition` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Composition are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Composition` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
