...
id: SCR-LIB-MORPHOLOGY-VOLUME
name: Morphology Volume
...
# SCR Morphology: Volume

## Summary

Three-dimensional interior density distribution, internal cavity organisation, and spatial occupancy.

---

## 1. Semantic Definition

**Volume** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses three-dimensional interior density distribution, internal cavity organisation, and spatial occupancy.
...
All operations within `Volume` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Volume are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Volume` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
