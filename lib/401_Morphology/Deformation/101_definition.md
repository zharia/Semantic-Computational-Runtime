...
id: SCR-LIB-MORPHOLOGY-DEFORMATION
name: Morphology Deformation
...
# SCR Morphology: Deformation

## Summary

Continuous distortion and modification of morphological form under physical or mathematical fields.

---

## 1. Semantic Definition

**Deformation** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses continuous distortion and modification of morphological form under physical or mathematical fields.
...
All operations within `Deformation` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Deformation are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Deformation` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
