...
id: SCR-LIB-MORPHOLOGY-MESH
name: Morphology Mesh
...
Discrete polyhedral network carrier for morphological surface and volume representation.

---

## 1. Semantic Definition

**Mesh** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses discrete polyhedral network carrier for morphological surface and volume representation.
...
All operations within `Mesh` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Mesh are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Mesh` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
