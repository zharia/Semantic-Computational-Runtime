...
id: SCR-LIB-MORPHOLOGY-SKELETON
name: Morphology Skeleton
...
# SCR Morphology: Skeleton

## Summary

Medial axis transform, curve skeleton, or topological armature capturing core morphological topology.

---

## 1. Semantic Definition

**Skeleton** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses medial axis transform, curve skeleton, or topological armature capturing core morphological topology.
...
All operations within `Skeleton` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Skeleton are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Skeleton` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
