...
id: SCR-LIB-MORPHOLOGY-GENERATION
name: Morphology Generation
...
# SCR Morphology: Generation

## Summary

Algorithmic, rule-based, and developmental synthesis of morphological forms.

---

## 1. Semantic Definition

**Generation** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses algorithmic, rule-based, and developmental synthesis of morphological forms.
...
All operations within `Generation` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Generation are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Generation` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
