...
id: SCR-LIB-MORPHOLOGY-AGGREGATION
name: Morphology Aggregation
...
# SCR Morphology: Aggregation

## Summary

Clustered accumulation and spatial grouping of constituent morphological units.

---

## 1. Semantic Definition

**Aggregation** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses clustered accumulation and spatial grouping of constituent morphological units.
...
All operations within `Aggregation` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Aggregation are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Aggregation` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
