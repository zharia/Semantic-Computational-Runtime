...
id: SCR-LIB-MORPHOLOGY-FRACTURE
name: Morphology Fracture
...
# SCR Morphology: Fracture

## Summary

Discontinuous structural breakage, crack propagation, and mechanical fission into distinct parts.

---

## 1. Semantic Definition

**Fracture** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses discontinuous structural breakage, crack propagation, and mechanical fission into distinct parts.
...
All operations within `Fracture` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Fracture are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Fracture` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
