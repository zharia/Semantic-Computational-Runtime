...
id: SCR-LIB-MORPHOLOGY-RECONSTRUCTION
...
# SCR Morphology: Reconstruction

## Summary

Inverse synthesis of morphological structure from sensor observations, point clouds, or slices.

---

## 1. Semantic Definition

**Reconstruction** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses inverse synthesis of morphological structure from sensor observations, point clouds, or slices.
...
All operations within `Reconstruction` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Reconstruction are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Reconstruction` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
