...
id: SCR-LIB-MORPHOLOGY-TRANSFORMATION
name: Morphology Transformation
...
# SCR Morphology: Transformation

## Summary

State transitions altering structural organisation, component relationships, or morphology.

---

## 1. Semantic Definition

**Transformation** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses state transitions altering structural organisation, component relationships, or morphology.
...
All operations within `Transformation` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Transformation are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Transformation` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
