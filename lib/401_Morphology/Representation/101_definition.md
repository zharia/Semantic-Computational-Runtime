...
id: SCR-LIB-MORPHOLOGY-REPRESENTATION
name: Morphology Representation
...
# SCR Morphology: Representation

## Summary

Technological carrier representations for morphological information, strictly subordinate to semantics.

---

## 1. Semantic Definition

**Representation** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses technological carrier representations for morphological information, strictly subordinate to semantics.
...
All operations within `Representation` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Representation are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Representation` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
