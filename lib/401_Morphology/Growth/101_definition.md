...
id: SCR-LIB-MORPHOLOGY-GROWTH
name: Morphology Growth
...
# SCR Morphology: Growth

## Summary

Constructive morphogenesis, developmental accretion, and volumetric expansion over time.

---

## 1. Semantic Definition

**Growth** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses constructive morphogenesis, developmental accretion, and volumetric expansion over time.
...
All operations within `Growth` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Growth are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Growth` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
