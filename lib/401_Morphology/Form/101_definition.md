...
id: SCR-LIB-MORPHOLOGY-FORM
name: Morphology Form
...
Macro-level structural configuration and qualitative manifestation of an organised entity.

---

## 1. Semantic Definition

**Form** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses macro-level structural configuration and qualitative manifestation of an organised entity.
...
All operations within `Form` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Form are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Form` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
