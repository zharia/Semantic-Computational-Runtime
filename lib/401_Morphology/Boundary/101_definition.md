...
id: SCR-LIB-MORPHOLOGY-BOUNDARY
name: Morphology Boundary
...
# SCR Morphology: Boundary

## Summary

Morphological boundary interface separating interior structure from surrounding domain.

---

## 1. Semantic Definition

**Boundary** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses morphological boundary interface separating interior structure from surrounding domain.
...
All operations within `Boundary` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Boundary are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Boundary` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
