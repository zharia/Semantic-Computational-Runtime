...
id: SCR-LIB-MORPHOLOGY-CORRESPONDENCE
name: Morphology Correspondence
...
# SCR Morphology: Correspondence

## Summary

Semantic registration and mapping of corresponding structural elements across distinct morphologies.

---

## 1. Semantic Definition

**Correspondence** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses semantic registration and mapping of corresponding structural elements across distinct morphologies.
...
All operations within `Correspondence` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Correspondence are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Correspondence` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
