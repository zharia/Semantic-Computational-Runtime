...
id: SCR-LIB-MORPHOLOGY-IMPLICIT
name: Morphology Implicit
...
# SCR Morphology: Implicit

## Summary

Continuous scalar potential and distance-field representations generating morphological forms.

---

## 1. Semantic Definition

**Implicit** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses continuous scalar potential and distance-field representations generating morphological forms.
...
All operations within `Implicit` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Implicit are authoritative and independent of carrier representations.
...
This document establishes the normative semantic meaning of `Implicit` in SCR Morphology. Implementations, data structures, and compiler transforms are subordinate to the contracts specified herein.
