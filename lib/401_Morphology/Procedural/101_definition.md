...
Grammar-based, fractally recursive, and parametric procedural generation of structures.

---

## 1. Semantic Definition

**Procedural** is a first-class subdomain of SCR Morphology (`SCR-LIB-MORPHOLOGY`). It addresses grammar-based, fractally recursive, and parametric procedural generation of structures.
...
All operations within `Procedural` MUST adhere to the normative invariants of `SCR-LIB-MORPHOLOGY`:
...
- **MORPHOLOGY-INV-016 (Representation Independence)**: The semantics of Procedural are authoritative and independent of carrier representations.
