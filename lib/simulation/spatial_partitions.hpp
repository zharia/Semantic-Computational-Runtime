        ...
        static const SpatialPartitionDescriptor descriptors[] = {
            {
                ...
                Material::ColorRGB(1.0f, 0.45f, 0.18f),
                Material::ColorRGB(0.40f, 0.18f, 0.08f),
                0.0035f,
                0.0f,
            ...
            },
            {
                ...
                Material::ColorRGB(0.20f, 0.85f, 0.40f),
                Material::ColorRGB(0.12f, 0.35f, 0.22f),
                0.0018f,
                1.0f,
            ...
            },
            {
                ...
                Material::ColorRGB(0.35f, 0.50f, 0.65f),
                Material::ColorRGB(0.20f, 0.30f, 0.45f),
                0.0022f,
                0.25f,
                0.8f,
                0.95f,
            ...
            },
            {
                ...
                Material::ColorRGB(0.10f, 0.90f, 0.85f),
                Material::ColorRGB(0.08f, 0.45f, 0.55f),
                0.0012f,
                0.40f,
            ...
            },
            {
                ...
                Material::ColorRGB(0.75f, 0.25f, 0.95f),
                Material::ColorRGB(0.15f, 0.05f, 0.25f),
                0.0065f,
                0.05f,
                0.4f,
                0.0f,
            ...
            },
            {
                ...
                Material::ColorRGB(0.08f, 0.25f, 0.55f),
                Material::ColorRGB(0.05f, 0.15f, 0.35f),
                0.0015f,
                0.0f,
