...
**Solid** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> 3D spatial region possessing volume, interior, and a continuous closed boundary surface.
