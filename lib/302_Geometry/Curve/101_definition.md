...
**Curve** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> 1D continuous spatial locus, including analytic, parametric (Bézier, B-spline, NURBS), and polyline curves.
