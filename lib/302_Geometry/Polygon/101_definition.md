...
# SCR Geometry — Polygon

## 1. Definition

**Polygon** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Planar 2D closed chain of linear segments, including convex, concave, and multi-boundary polygons.
