...
id: SCR-LIB-GEOMETRY-INTERSECTION
...
**Intersection** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Geometric predicates and constructive queries determining intersections between rays, lines, and shapes.
