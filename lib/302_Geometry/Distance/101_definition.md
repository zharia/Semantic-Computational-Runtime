...
# SCR Geometry — Distance

## 1. Definition

**Distance** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Metric distance evaluations (Euclidean, Manhattan, Chebyshev, geodesic) between geometric entities.
