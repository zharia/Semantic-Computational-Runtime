...
**Vector** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Directed spatial displacement possessing direction and magnitude, subject to linear space operations.
