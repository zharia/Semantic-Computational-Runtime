...
# SCR Geometry — Proximity

## 1. Definition

**Proximity** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Spatial neighborhood queries, bounds queries, and nearest-entity relations.
