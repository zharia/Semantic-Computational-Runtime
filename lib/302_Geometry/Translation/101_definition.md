...
id: SCR-LIB-GEOMETRY-TRANSLATION
...
# SCR Geometry — Translation

## 1. Definition

**Translation** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Uniform vector displacement applied across all spatial points of a geometric entity.
