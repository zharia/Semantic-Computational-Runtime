...
id: SCR-LIB-GEOMETRY-SURFACE
name: Geometry Surface
...
# SCR Geometry — Surface

## 1. Definition

**Surface** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> 2D continuous manifold or boundary embedded in spatial dimensions (parametric, implicit, or triangulated).
