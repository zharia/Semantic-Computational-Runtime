...
id: SCR-LIB-GEOMETRY-COMPUTATIONAL
name: Geometry Computational
...
# SCR Geometry — Computational

## 1. Definition

**Computational** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Algorithmic computational geometry routines (convex hulls, bounding volumes, spatial partitions).
