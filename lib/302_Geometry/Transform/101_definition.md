...
# SCR Geometry — Transform

## 1. Definition

**Transform** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Affine, rigid-body, and projective transformations preserving designated spatial invariants.
