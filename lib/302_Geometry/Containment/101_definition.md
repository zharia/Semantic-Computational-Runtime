...
id: SCR-LIB-GEOMETRY-CONTAINMENT
name: Geometry Containment
...
# SCR Geometry — Containment

## 1. Definition

**Containment** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Predicates determining whether a point, line, or volume resides inside, on the boundary of, or outside an entity.
