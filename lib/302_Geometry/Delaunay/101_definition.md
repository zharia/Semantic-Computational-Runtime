...
id: SCR-LIB-GEOMETRY-DELAUNAY
name: Geometry Delaunay
...
# SCR Geometry — Delaunay

## 1. Definition

**Delaunay** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Delaunay triangulation and tetrahedralization satisfying the empty circumscribed hypersphere condition.
