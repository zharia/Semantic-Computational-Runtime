...
**Mesh** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Discrete geometric representation composed of vertices, edges, and polygonal/polyhedral facets with connectivity topology.
