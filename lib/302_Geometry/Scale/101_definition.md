...
**Scale** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Isotropic or anisotropic metric scaling transformation altering entity dimensions.
