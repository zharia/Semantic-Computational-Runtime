...
**Plane** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Infinite 2D planar subspace defined by a point and a normal vector, or linear equation.
