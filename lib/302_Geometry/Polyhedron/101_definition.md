...
id: SCR-LIB-GEOMETRY-POLYHEDRON
...
# SCR Geometry — Polyhedron

## 1. Definition

**Polyhedron** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> 3D solid or surface bounded by planar polygonal faces, conforming to Euler-Poincaré characteristics.
