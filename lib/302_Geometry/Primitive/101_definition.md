...
**Primitive** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Foundational closed and open geometric primitives (points, segments, rays, planes, spheres, boxes, triangles).
