...
id: SCR-LIB-GEOMETRY-TRIANGULATION
...
# SCR Geometry — Triangulation

## 1. Definition

**Triangulation** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Decomposition of polygons, point clouds, or surfaces into networks of non-overlapping triangles.
