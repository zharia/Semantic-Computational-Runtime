...
# SCR Geometry — Segment

## 1. Definition

**Segment** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Bounded 1D linear segment defined by two terminal endpoints in spatial dimension.
