...
**Ray** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Semi-infinite 1D directed entity defined by an origin point and a unit direction vector.
