...
**Line** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Infinite 1D linear geometric entity passing through points or defined by a point and direction vector.
