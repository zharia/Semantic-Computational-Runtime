...
id: SCR-LIB-GEOMETRY-IMPLICIT
name: Geometry Implicit
...
# SCR Geometry — Implicit

## 1. Definition

**Implicit** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Geometry defined as the zero-isosurface of continuous spatial scalar functions f(x, y, z) = 0.
