...
id: SCR-LIB-GEOMETRY-COLLISION
name: Geometry Collision
...
# SCR Geometry — Collision

## 1. Definition

**Collision** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Continuous and discrete interference, collision detection, and separating-axis evaluation between geometries.
