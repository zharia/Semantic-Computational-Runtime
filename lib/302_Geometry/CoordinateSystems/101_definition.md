...
id: SCR-LIB-GEOMETRY-COORDINATESYSTEMS
name: Geometry CoordinateSystems
...
# SCR Geometry — CoordinateSystems

## 1. Definition

**CoordinateSystems** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Coordinate reference frames (Cartesian, spherical, cylindrical, curvilinear, barycentric) establishing spatial coordinates.
