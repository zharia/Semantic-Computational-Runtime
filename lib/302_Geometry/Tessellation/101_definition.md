...
id: SCR-LIB-GEOMETRY-TESSELLATION
...
# SCR Geometry — Tessellation

## 1. Definition

**Tessellation** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Decomposition of continuous surfaces or volumes into discrete adjoining geometric primitives without overlaps.
