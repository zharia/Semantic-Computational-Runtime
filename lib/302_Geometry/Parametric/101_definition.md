...
id: SCR-LIB-GEOMETRY-PARAMETRIC
...
# SCR Geometry — Parametric

## 1. Definition

**Parametric** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Geometry defined via continuous parametric mapping functions from a parameter domain to spatial embedding.
