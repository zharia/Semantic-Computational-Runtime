...
id: SCR-LIB-GEOMETRY-VORONOI
name: Geometry Voronoi
...
# SCR Geometry — Voronoi

## 1. Definition

**Voronoi** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Dual spatial partitioning into convex Voronoi cells based on proximity to a discrete generating point set.
