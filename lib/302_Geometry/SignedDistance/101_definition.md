...
id: SCR-LIB-GEOMETRY-SIGNEDDISTANCE
name: Geometry SignedDistance
...
# SCR Geometry — SignedDistance

## 1. Definition

**SignedDistance** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Signed Distance Fields (SDF) providing exact orthogonal distance to geometric boundaries with inside/outside sign.
