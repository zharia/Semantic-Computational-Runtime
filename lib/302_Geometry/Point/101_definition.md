...
**Point** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> 0D spatial position in affine space representing location without extent, distinct from displacement vectors.
