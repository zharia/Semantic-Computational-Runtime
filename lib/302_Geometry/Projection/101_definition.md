...
id: SCR-LIB-GEOMETRY-PROJECTION
...
# SCR Geometry — Projection

## 1. Definition

**Projection** is the normative geometric subdomain within `SCR-LIB-GEOMETRY` responsible for:
> Dimensional reduction or projection transformations (orthogonal, perspective, stereographic) onto subspaces.
