...
id: SCR-LIB-PHYSICS-PRESSURE
name: Physics Pressure
...
# SCR Physics: Pressure

## Summary

Normal force per unit surface area distributed across fluids, solids, or thermodynamic boundaries.

---

## 1. Semantic Definition

**Pressure** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines normal force per unit surface area distributed across fluids, solids, or thermodynamic boundaries.
...
All operations within `Pressure` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Pressure` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
