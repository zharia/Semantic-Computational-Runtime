...
# SCR Physics: Equations

## Summary

Differential, algebraic, and integral mathematical formulations expressing physical laws.

---

## 1. Semantic Definition

**Equations** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines differential, algebraic, and integral mathematical formulations expressing physical laws.
...
All operations within `Equations` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Equations` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
