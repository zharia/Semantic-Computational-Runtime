...
id: SCR-LIB-PHYSICS-ELECTROMAGNETIC
...
# SCR Physics: Electromagnetic

## Summary

Interactions between charged particles mediated by electric, magnetic, and radiation fields.

---

## 1. Semantic Definition

**Electromagnetic** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines interactions between charged particles mediated by electric, magnetic, and radiation fields.
...
All operations within `Electromagnetic` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Electromagnetic` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
