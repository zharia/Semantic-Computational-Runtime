...
Conserved scalar quantity representing work capacity (kinetic, potential, thermal, internal, field energy).

---

## 1. Semantic Definition

**Energy** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines conserved scalar quantity representing work capacity (kinetic, potential, thermal, internal, field energy).
...
All operations within `Energy` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Energy` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
