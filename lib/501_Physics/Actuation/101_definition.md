...
id: SCR-LIB-PHYSICS-ACTUATION
name: Physics Actuation
...
# SCR Physics: Actuation

## Summary

Application of external energy or forces to control, steer, or drive physical systems.

---

## 1. Semantic Definition

**Actuation** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines application of external energy or forces to control, steer, or drive physical systems.
...
All operations within `Actuation` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Actuation` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
