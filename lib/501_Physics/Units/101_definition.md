...
Standard reference quantities (SI system, base and derived units) establishing scale for measurement.

---

## 1. Semantic Definition

**Units** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines standard reference quantities (SI system, base and derived units) establishing scale for measurement.
...
All operations within `Units` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Units` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
