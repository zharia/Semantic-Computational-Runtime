...
Authoritative physical laws (Newton's laws, Maxwell's equations, Conservation principles, Thermodynamics).

---

## 1. Semantic Definition

**Laws** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines authoritative physical laws (Newton's laws, Maxwell's equations, Conservation principles, Thermodynamics).
...
All operations within `Laws` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Laws` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
