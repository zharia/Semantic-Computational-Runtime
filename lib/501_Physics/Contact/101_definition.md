...
Boundary interaction, non-penetration condition, and normal force transmission between touching bodies.

---

## 1. Semantic Definition

**Contact** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines boundary interaction, non-penetration condition, and normal force transmission between touching bodies.
...
All operations within `Contact` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Contact` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
