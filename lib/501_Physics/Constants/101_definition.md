...
# SCR Physics: Constants

## Summary

Universal physical invariants (speed of light, gravitational constant, Planck constant, Boltzmann constant).

---

## 1. Semantic Definition

**Constants** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines universal physical invariants (speed of light, gravitational constant, Planck constant, Boltzmann constant).
...
All operations within `Constants` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Constants` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
