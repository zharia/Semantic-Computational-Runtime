...
id: SCR-LIB-PHYSICS-DIMENSIONS
name: Physics Dimensions
...
# SCR Physics: Dimensions

## Summary

Fundamental dimensional dimensions ([M], [L], [T], [I], [Theta], [N], [J]) ensuring dimensional consistency.

---

## 1. Semantic Definition

**Dimensions** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines fundamental dimensional dimensions ([M], [L], [T], [I], [Theta], [N], [J]) ensuring dimensional consistency.
...
All operations within `Dimensions` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Dimensions` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
