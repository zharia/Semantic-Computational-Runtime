...
id: SCR-LIB-PHYSICS-ENTROPY
name: Physics Entropy
...
Measure of microscopic state degeneracy, disorder, and thermodynamic irreversibility.

---

## 1. Semantic Definition

**Entropy** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines measure of microscopic state degeneracy, disorder, and thermodynamic irreversibility.
...
All operations within `Entropy` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Entropy` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
