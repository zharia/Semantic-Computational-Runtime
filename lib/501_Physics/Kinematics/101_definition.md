...
# SCR Physics: Kinematics

## Summary

Geometric and temporal description of motion (position, velocity, acceleration, trajectory) without forces.

---

## 1. Semantic Definition

**Kinematics** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines geometric and temporal description of motion (position, velocity, acceleration, trajectory) without forces.
...
All operations within `Kinematics` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Kinematics` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
