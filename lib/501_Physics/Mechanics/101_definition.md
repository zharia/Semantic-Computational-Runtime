...
# SCR Physics: Mechanics

## Summary

Fundamental principles of classical, relativistic, and continuum physical dynamics.

---

## 1. Semantic Definition

**Mechanics** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines fundamental principles of classical, relativistic, and continuum physical dynamics.
...
All operations within `Mechanics` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Mechanics` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
