...
# SCR Physics: RigidBody

## Summary

Idealized physical body whose internal distances and geometry remain invariant under stress.

---

## 1. Semantic Definition

**RigidBody** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines idealized physical body whose internal distances and geometry remain invariant under stress.
...
All operations within `RigidBody` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `RigidBody` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
