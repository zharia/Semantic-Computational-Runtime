...
id: SCR-LIB-PHYSICS-PARTICLE
name: Physics Particle
...
# SCR Physics: Particle

## Summary

Zero-dimensional ideal point mass possessing position, velocity, and point charges.

---

## 1. Semantic Definition

**Particle** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines zero-dimensional ideal point mass possessing position, velocity, and point charges.
...
All operations within `Particle` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Particle` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
