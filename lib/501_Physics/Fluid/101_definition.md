...
Continuum matter (liquids, gases, plasmas) that continuously deforms under shear stress.

---

## 1. Semantic Definition

**Fluid** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines continuum matter (liquids, gases, plasmas) that continuously deforms under shear stress.
...
All operations within `Fluid` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Fluid` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
