...
# SCR Physics: Friction

## Summary

Resistive force opposing relative tangential motion between contacting physical surfaces.

---

## 1. Semantic Definition

**Friction** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines resistive force opposing relative tangential motion between contacting physical surfaces.
...
All operations within `Friction` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Friction` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
