...
id: SCR-LIB-PHYSICS-INTEGRATORS
name: Physics Integrators
...
# SCR Physics: Integrators

## Summary

Temporal integration schemes (symplectic, explicit, implicit, Runge-Kutta) advancing physical state.

---

## 1. Semantic Definition

**Integrators** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines temporal integration schemes (symplectic, explicit, implicit, Runge-Kutta) advancing physical state.
...
All operations within `Integrators` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Integrators` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
