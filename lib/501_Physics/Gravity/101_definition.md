...
Universal attractive interaction governed by mass-energy distributions and curvature.

---

## 1. Semantic Definition

**Gravity** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines universal attractive interaction governed by mass-energy distributions and curvature.
...
All operations within `Gravity` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Gravity` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
