...
id: SCR-LIB-PHYSICS-CONSTRAINTS
...
# SCR Physics: Constraints

## Summary

Kinematic and dynamic restrictions (holonomic, non-holonomic, joints, bilateral, unilateral) on physical motion.

---

## 1. Semantic Definition

**Constraints** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines kinematic and dynamic restrictions (holonomic, non-holonomic, joints, bilateral, unilateral) on physical motion.
...
All operations within `Constraints` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Constraints` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
