...
# SCR Physics: Collision

## Summary

Discrete or continuous high-energy impulsive interaction between intersecting physical bodies.

---

## 1. Semantic Definition

**Collision** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines discrete or continuous high-energy impulsive interaction between intersecting physical bodies.
...
All operations within `Collision` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Collision` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
