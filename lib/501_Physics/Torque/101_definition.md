...
Rotational moment of force causing change in angular momentum or rotational acceleration.

---

## 1. Semantic Definition

**Torque** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines rotational moment of force causing change in angular momentum or rotational acceleration.
...
All operations within `Torque` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Torque` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
