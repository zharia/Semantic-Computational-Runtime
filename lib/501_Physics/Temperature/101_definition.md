...
id: SCR-LIB-PHYSICS-TEMPERATURE
...
# SCR Physics: Temperature

## Summary

Thermodynamic measure of mean kinetic energy and thermal equilibrium state.

---

## 1. Semantic Definition

**Temperature** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines thermodynamic measure of mean kinetic energy and thermal equilibrium state.
...
All operations within `Temperature` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Temperature` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
