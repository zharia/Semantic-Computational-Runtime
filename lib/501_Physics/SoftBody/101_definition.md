...
id: SCR-LIB-PHYSICS-SOFTBODY
name: Physics SoftBody
...
# SCR Physics: SoftBody

## Summary

Deformable physical entity governed by elasticity, plasticity, and continuum mechanics.

---

## 1. Semantic Definition

**SoftBody** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines deformable physical entity governed by elasticity, plasticity, and continuum mechanics.
...
All operations within `SoftBody` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `SoftBody` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
