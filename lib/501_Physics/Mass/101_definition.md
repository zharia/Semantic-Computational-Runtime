...
Measure of physical inertia, gravitational coupling, and material quantity.

---

## 1. Semantic Definition

**Mass** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines measure of physical inertia, gravitational coupling, and material quantity.
...
All operations within `Mass` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Mass` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
