...
Fundamental property of matter causing electromagnetic interaction and conserved current.

---

## 1. Semantic Definition

**Charge** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines fundamental property of matter causing electromagnetic interaction and conserved current.
...
All operations within `Charge` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Charge` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
