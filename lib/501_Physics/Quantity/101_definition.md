...
id: SCR-LIB-PHYSICS-QUANTITY
name: Physics Quantity
...
# SCR Physics: Quantity

## Summary

Measurable physical property possessing value, uncertainty, unit, and dimensional profile.

---

## 1. Semantic Definition

**Quantity** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines measurable physical property possessing value, uncertainty, unit, and dimensional profile.
...
All operations within `Quantity` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Quantity` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
