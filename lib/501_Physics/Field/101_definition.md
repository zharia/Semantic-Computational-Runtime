...
Spatial and temporal distribution of physical quantities (gravitational, electromagnetic, stress).

---

## 1. Semantic Definition

**Field** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines spatial and temporal distribution of physical quantities (gravitational, electromagnetic, stress).
...
All operations within `Field` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Field` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
