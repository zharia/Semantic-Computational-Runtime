...
id: SCR-LIB-PHYSICS-THERMODYNAMIC
name: Physics Thermodynamic
...
# SCR Physics: Thermodynamic

## Summary

Laws governing heat, work, temperature, and thermal phase transitions.

---

## 1. Semantic Definition

**Thermodynamic** is a first-class subdomain of SCR Physics (`SCR-LIB-PHYSICS`). It defines laws governing heat, work, temperature, and thermal phase transitions.
...
All operations within `Thermodynamic` MUST adhere to the normative invariants of `SCR-LIB-PHYSICS`:
...
This document establishes the normative semantic meaning of `Thermodynamic` in SCR Physics. Numerical engines, solvers, and simulation runtimes are subordinate to the contracts specified herein.
