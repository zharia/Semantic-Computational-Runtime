...
This directory is MLIR dialect material for the Spatial domain.
...
The directory establishes the MLIR dialect location for Spatial.

## Relationship to Parent

`IR` is a child of `801_Spatial` and represents the MLIR dialect scope for the Spatial semantic domain.
...
The Spatial MLIR dialect has not yet been independently specified. This directory serves as a structural placeholder for future MLIR dialect development.
