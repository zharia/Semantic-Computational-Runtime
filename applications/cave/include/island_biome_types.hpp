...
struct IslandDescriptor {
    ...
    float boid_density;
    Ogre::ColourValue water_shallow_color;
    Ogre::ColourValue water_deep_color;
        ...
        static const std::vector<IslandDescriptor> islands = {
            {
                ...
                0.65f,
                1.2f,
                Ogre::ColourValue(0.04f, 0.28f, 0.36f, 0.72f), // Tropical reef teal
                Ogre::ColourValue(0.01f, 0.08f, 0.20f, 0.95f), // Deep indigo
                Ogre::ColourValue(1.0f, 0.88f, 0.76f),
                Ogre::ColourValue(0.40f, 0.48f, 0.60f),
                0.0018f,
                0.85f,
                42.0f
            },
            {
                ...
                1.40f,
                1.5f,
                Ogre::ColourValue(0.02f, 0.40f, 0.30f, 0.68f), // Emerald jade shallows
                Ogre::ColourValue(0.01f, 0.12f, 0.18f, 0.95f),
                Ogre::ColourValue(0.92f, 1.0f, 0.90f),
                Ogre::ColourValue(0.28f, 0.52f, 0.42f),
                0.0028f,
                0.65f,
                29.0f
            },
            {
                ...
                0.35f,
                0.8f,
                Ogre::ColourValue(0.08f, 0.45f, 0.52f, 0.60f), // Aquamarine
                Ogre::ColourValue(0.02f, 0.10f, 0.25f, 0.95f),
                Ogre::ColourValue(1.0f, 0.95f, 0.80f),
                Ogre::ColourValue(0.70f, 0.58f, 0.42f),
                0.0015f,
                0.55f,
                38.0f
            },
            {
                ...
                0.20f,
                0.7f,
                Ogre::ColourValue(0.18f, 0.48f, 0.62f, 0.75f), // Glacial cyan
                Ogre::ColourValue(0.03f, 0.09f, 0.22f, 0.96f),
                Ogre::ColourValue(0.85f, 0.92f, 1.0f),
                Ogre::ColourValue(0.65f, 0.75f, 0.88f),
                0.0032f,
                0.95f,
                -12.0f
            },
            {
                ...
                0.90f,
                1.8f,
                Ogre::ColourValue(0.10f, 0.55f, 0.60f, 0.55f), // Ultra crystal turquoise
                Ogre::ColourValue(0.01f, 0.12f, 0.28f, 0.95f),
                Ogre::ColourValue(1.0f, 1.0f, 0.92f),
                Ogre::ColourValue(0.40f, 0.62f, 0.72f),
                0.0012f,
                0.70f,
                27.0f
            }
